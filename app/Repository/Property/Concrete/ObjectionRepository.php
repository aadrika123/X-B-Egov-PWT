    ...
    public function applyObjection($request)
    {
        try {
            ...
            if ($objectionFor == "Clerical Mistake") {
                ...
                $objection->appartment_name = $propDtl->appartment_name;
                $objection->no_electric_connection = $propDtl->no_electric_connection;
                $objection->elect_consumer_no = $propDtl->elect_consumer_no;
                $objection->elect_acc_no = $propDtl->elect_acc_no;
                $objection->elect_bind_book_no = $propDtl->elect_bind_book_no;
                $objection->elect_cons_category = $propDtl->elect_cons_category;
                $objection->building_plan_approval_no = $propDtl->building_plan_approval_no;
                $objection->building_plan_approval_date = $propDtl->building_plan_approval_date;
                $objection->water_conn_no = $propDtl->water_conn_no;
                $objection->water_conn_date = $propDtl->water_conn_date;
                $objection->khata_no = $propDtl->khata_no;
                $objection->plot_no = $propDtl->plot_no;
                $objection->village_mauja_name = $propDtl->village_mauja_name;
                ...
                $objection->prop_city = $propDtl->prop_city;
                $objection->prop_dist = $propDtl->prop_dist;
                $objection->prop_pin_code = $propDtl->prop_pin_code;
                $objection->prop_state = $propDtl->prop_state;
                $objection->is_mobile_tower = $propDtl->is_mobile_tower;
                $objection->tower_area = $propDtl->tower_area;
                $objection->tower_installation_date = $propDtl->tower_installation_date;
                $objection->is_hoarding_board = $propDtl->is_hoarding_board;
                $objection->hoarding_area = $propDtl->hoarding_area;
                $objection->hoarding_installation_date = $propDtl->hoarding_installation_date;
                $objection->is_petrol_pump = $propDtl->is_petrol_pump;
                $objection->under_ground_area = $propDtl->under_ground_area;
                $objection->petrol_pump_completion_date = $propDtl->petrol_pump_completion_date;
                $objection->is_water_harvesting = $propDtl->is_water_harvesting;
                $objection->land_occupation_date = $propDtl->land_occupation_date;
                $objection->new_ward_mstr_id = $propDtl->new_ward_mstr_id;
                $objection->entry_type = $propDtl->entry_type;
                $objection->zone_mstr_id = $propDtl->zone_mstr_id;
                $objection->new_holding_no = $propDtl->new_holding_no;
                $objection->flat_registry_date = $propDtl->flat_registry_date;
                $objection->assessment_type = $propDtl->assessment_type;
                $objection->holding_type = $propDtl->holding_type;
                $objection->is_old = $propDtl->is_old;
                $objection->apartment_details_id = $propDtl->apartment_details_id;
                $objection->road_width = $propDtl->road_width;
                $objection->saf_no = $propDtl->saf_no;
                $objection->pt_no = $propDtl->pt_no;
                $objection->building_name = $propDtl->building_name;
                $objection->street_name = $propDtl->saf_no;
                $objection->saf_no = $propDtl->street_name;
                $objection->location = $propDtl->location;
                $objection->landmark = $propDtl->landmark;
                $objection->is_gb_saf = $propDtl->is_gb_saf;
                $objection->gb_office_name = $propDtl->gb_office_name;
                $objection->gb_usage_types = $propDtl->gb_usage_types;
                $objection->gb_prop_usage_types = $propDtl->gb_prop_usage_types;
                $objection->is_trust = $propDtl->is_trust;
                $objection->trust_type = $propDtl->trust_type;
                $objection->gb_prop_usage_types = $propDtl->gb_prop_usage_types;
                $objection->is_trust_verified = $propDtl->is_trust_verified;
                $objection->rwh_date_from = $propDtl->rwh_date_from;
                $objection->category_id = $propDtl->category_id;
                $objection->is_waived_off = $propDtl->is_waived_off;
                $objection->property_no = $propDtl->property_no;
