...
class WaterConsumer extends Controller
{
    ...
    public function updateConnectionType(reqMeterEntry $request)
    {
        try {
            ...
            $m_demand->updateMeterConnection($connectionType, $request->consumerId);
    ...
    public function tcVisitReportsById(Request $request)
    {
        ...
        try {
            ...
            $newConsumerData     = new WaterSecondConsumer();
            $mWaterTcVisitReport = new WaterTcVisitReport();
            $tcRecord            = $mWaterTcVisitReport->getDetailsRecords($request)->first();
            $data = [
                'tcReocord' => $tcRecord,
    ...
    public function searchDemandDeactivate(Request $request)
    {
        ...
        try {
            ...
            $data = WaterDemandDeactivateLog::select(
                ...
                "water_demand_deactivate_logs.logged_at",
                "water_demand_deactivate_logs.generation_date",
                "zone_masters.zone_name",
                "ulb_ward_masters.ward_name",
                "owners.applicant_name",
                "owners.guardian_name",
