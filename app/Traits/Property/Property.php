...
trait Property
{
    public function generatePropUpdateRequest(Request $request, PropProperty $property, bool $fullEdit = false)
    {
        ...
        if ($fullEdit) {
            $arr2 = [
                ...
                "mobileTower" => [
                    "area" => $request->mobileTower['area'] ??  $property->tower_area,
                ...
                "hoardingBoard" => [
                    "area" => $request->hoardingBoard['area'] ??  $property->hoarding_area,
                ...
                "petrolPump" => [
                    "area" => $request->petrolPump['area'] ??  $property->under_ground_area,
    ...
    public function updateProperty(PropPropertyUpdateRequest $UpdateRequest)
    {
        ...
        if ($UpdateRequest->is_full_update || $UpdateRequest->objection_for == 'Assessment Error') {
